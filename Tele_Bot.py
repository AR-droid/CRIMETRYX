...
SCAM_KEYWORDS = [
    ...
    "investment opportunity", "no risk", "get rich quick", "limited time offer", "jackpot","bumper prize"
]
...
async def search_and_analyze_channels():
    base_search_terms = ["crypto", "bitcoin", "investment", "profit", "trading", "forex", "stock market"]
    processed_channels = load_processed_channels()
    flagged_data = []
    max_channels_to_check = 100
    total_checked = 0
    iterations = 0
